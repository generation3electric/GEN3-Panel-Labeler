...
- Circuit #1 location selector in panel setup and review (top/bottom, left/right); saves with review progress and final records, controls the physical view and printed directory, and guides AI numbering. Existing records default to top left.
